...
# ─── SafeSense AI integration (Phase 6 Batch 1) ──────────────────────────────
# Alembic owns schema management for non-SQLite (PostgreSQL) deployments and
# can also manage SQLite when explicitly pointed at it via -x db_url=….
